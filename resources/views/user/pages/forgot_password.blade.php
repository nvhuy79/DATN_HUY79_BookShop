...
<!-- Mirrored from htmldemo.net/lezada/lezada/shop-product-with-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Apr 2024 14:15:56 GMT -->
<head>
	<meta charset="utf-8">
										...
										<div class="widget-product-wrapper">
												...
												<div class="single-widget-product">
													...
													<div class="single-widget-product__image">
														<a href="shop-product-basic.html">
															<img src="assets/images/products/product-furniture-2-100x100.jpg" class="img-fluid"
																alt="">
														</a>
													</div>
											...
											<div class="single-widget-product-wrapper">
												<div class="single-widget-product">
													...
													<div class="single-widget-product__image">
														<a href="shop-product-basic.html">
															<img src="assets/images/products/product-furniture-11-100x100.jpg" class="img-fluid"
																alt="">
														</a>
													</div>
