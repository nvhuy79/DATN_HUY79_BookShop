            ...
            <div class="row">
                <div class="col-lg-12">
                    <div id="rev_slider_4_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container"
                        data-alias="homepage-6" data-source="gallery">
                        ...
                        <div id="rev_slider_4_1" class="rev_slider fullwidthabanner" style="display:none;"
                            ...
                            <ul>
                                <li data-index="rs-10"
                                    ...
                                    data-thumb="{{ asset('user/images/slider/sld1.jpg') }}" data-rotate="0,0,0,0,0,0,0,0"
                                    ...
                                    <div class="tp-caption   tp-resizeme" id="slide-10-layer-13"
                                        data-x="['left','center','left','left']" data-hoffset="['376','-301','81','32']"
                                        data-y="['top','top','top','top']" data-voffset="['280','305','275','216']"
                                    ...
                                    <div class="tp-caption   tp-resizeme" id="slide-10-layer-3"
                                        data-x="['left','center','center','left']" data-hoffset="['372','-209','-85','34']"
                                        data-y="['top','middle','middle','top']" data-voffset="['330','0','-127','271']"
                                        data-fontsize="['56','56','56','50']" data-width="none" data-height="none"
                                        data-whitespace="nowrap" data-type="text" data-responsive_offset="on"
                                    ...
                                    <div class="tp-caption Slider-button-alt rev-btn  tp-resizeme" id="slide-10-layer-20"
                                        ...
                                        <a class="revslider-button" href="shop-left-sidebar.html"> SHOP NOW</a>
                                    </div>
                                </li>
                                <!-- SLIDE  -->
                                <li data-index="rs-11"
                                    ...
                                    data-rotate="0,0,0,0,0,0" data-saveperformance="off" data-title="Slide"
                                    ...
                                    <div class="tp-caption   tp-resizeme" id="slide-11-layer-13"
                                        ...
                                        data-letterspacing="['','','0','0']" data-width="none" data-height="none"
                                        data-whitespace="nowrap" data-type="text" data-responsive_offset="on"
                                        data-frames='[{"delay":700,"speed":2022,"sfxcolor":"#ffffff","sfx_effect":"blockfromleft","frame":"0","from":"z:0;","to":"o:1;","ease":"Power4.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]'
                                        data-textAlign="['inherit','inherit','inherit','inherit']"
                                        data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
                                        data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                                        style="z-index: 5; white-space: nowrap; font-size: 24px; line-height: 36px; font-weight: 400; color: #333333; letter-spacing: 0px;font-family:Work Sans;">
                                    ...
                                    <div class="tp-caption Slider-button-alt rev-btn  tp-resizeme" id="slide-11-layer-20"
                                        data-x="['left','center','center','left']"
                                        data-hoffset="['377','-358','-233','32']" data-y="['top','top','top','top']"
                                        data-voffset="['438','457','427','368']" data-width="none" data-height="none"
                        ...
                        <div class="single-product">
                            <div class="single-product__image">
                                <a class="image-wrap" href="shop-product-basic.html">
                                    <img src="{{ asset('storage/admin/images') }}/{{ $item->image }}" class="img-fluid product-image"
                                        alt="">
                                </a>
