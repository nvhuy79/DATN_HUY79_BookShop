                                ...
                                <div class="modal-content cs_modal">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('shippingfee.store') }}" method="POST">
                                            @csrf
                                            <div>
                                                <label class="form-label" for="city" style="font-size: 16px">Tỉnh/Thành phố</label><br>
                                                <select class="form-select form-select-sm mb-3" id="city" name="city_id" aria-label=".form-select-sm" style="font-size: 15px">
                                                    <option value="" selected>---Chọn Tỉnh/Thành phố---</option>
                                                </select>
                                        
                                                <label class="form-label" for="district" style="font-size: 16px">Quận/Huyện</label><br>
                                                <select class="form-select form-select-sm mb-3" id="district" name="district_id" aria-label=".form-select-sm" style="font-size: 15px"> 
                                                    <option value="" selected>---Chọn Quận/Huyện---</option>
                                                </select>
                                        
                                                <label class="form-label" for="ward" style="font-size: 16px">Phường/Xã</label><br>
                                                <select class="form-select form-select-sm" id="ward" name="ward_id" aria-label=".form-select-sm" style="font-size: 15px">
                                            ...
                                            <button type="submit" name="select_shippingfee" class="btn_1 full_width text-center add_shippingfee">Thêm mới</button>
                                        </form>
