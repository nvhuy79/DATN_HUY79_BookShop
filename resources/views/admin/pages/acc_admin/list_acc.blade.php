                ...
                <div class="white_card_body">
                    <div class="QA_section">
                        <div class="white_box_tittle list_header">
                            <a href="{{ route('admin_add') }}" class="btn_1" style="background-color: rgb(50, 165, 50)">+ Thêm
                                tài khoản</a>
                            <form action="{{ route('list_acc_admin_search') }}" method="GET">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="action_btns d-flex">
                                                    <a href="{{ route('edit_acc_admin', $item) }}"
                                                        class="action_btn mr_10"><i class="far fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('delete_acc_admin', $item) }}" method="POST"
                    ...
                    <nav aria-label="Page navigation examplee">
                        <ul class="pagination">
                            ...
                            @else
                                <li class="page-item"><a class="page-link" href="{{ $admins->previousPageUrl() }}"
                            ...
                            @if ($admins->hasMorePages())
                                <li class="page-item"><a class="page-link" href="{{ $admins->nextPageUrl() }}"
