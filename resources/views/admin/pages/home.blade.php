                            ...
                            <div class="white_card_body">
                                ...
                                <div class="social_media_list">
                                    <div class="single_media d-flex justify-content-between align-items-center">
                                        <span class="mediaName"> <img src="assets/admin/img/currency/1.svg" alt>
                                            Bitcoin</span>
                                    ...
                                    <div class="single_media d-flex justify-content-between align-items-center">
                                        <span class="mediaName"> <img src="assets/admin/img/currency/2.svg" alt>
                                            Litecoin</span>
                                        <span class="earning_amount">
                                            <h4>0.000242 BTC</h4>
                                            <p>0.125 USD</p>
                                    ...
                                    <div class="single_media d-flex justify-content-between align-items-center">
                                        <span class="mediaName"> <img src="assets/admin/img/currency/3.svg" alt>
                                            Ripple</span>
                                        <span class="earning_amount">
                                            <h4>0.000242 BTC</h4>
                                            <p>0.125 USD</p>
                                            ...
                                            <table class="table  ">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td> <img class="small_img"
                                                                src="assets/admin/img/currency/1.svg" alt> Bitcoin
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <img class="small_img"
                                                                src="assets/admin/img/currency/2.svg" alt> Bitcoin
                                                        </td>
                                                        <td>Using - Bank......4585 </td>
                                                        <td>-0.000234 BTC</td>
                                                        <td>-0.454 USD</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <img class="small_img"
                                                                src="assets/admin/img/currency/4.svg" alt> Bitcoin
                                                        </td>
                                                        <td>Using - Bank......4585 </td>
                                                        <td>-0.000234 BTC</td>
                                                        <td>-0.454 USD</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <img class="small_img"
                                                                src="assets/admin/img/currency/3.svg" alt> Bitcoin
                                                        </td>
                                                        <td>Using - Bank......4585 </td>
                                                        <td>-0.000234 BTC</td>
                                                        <td>-0.454 USD</td>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="single_transfer_pro text-center">
                                                    <div class="thumb">
                                                        <img src="assets/admin/img/transfer/1.png" alt>
                                                    </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="single_transfer_pro text-center">
                                                    <div class="thumb">
                                                        <img src="assets/admin/img/transfer/2.png" alt>
                                                    </div>
                                                    <h5 class="f_s_14 f_w_400 mb-0">Samuel</h5>
                                                    <p class="f_s_11 f_w_400">@samuel15</p>
                                                </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="single_transfer_pro text-center">
                                                    <div class="thumb">
                                                        <img src="assets/admin/img/transfer/3.png" alt>
                                                    </div>
                                                    <h5 class="f_s_14 f_w_400 mb-0">Samuel</h5>
                                                    <p class="f_s_11 f_w_400">@samuel15</p>
                                                </div>
                                    ...
                                    <div class="white_card_header">
                                        <div class="box_header m-0">
                                            ...
                                            <div class="erning_btn d-flex">
                                                <a href="#"
                                                    class="small_blue_btn radius_0 border-right-0">Month</a>
                                            ...
                                            <div class="QA_table mb-0">
                                                ...
                                                <table class="table lms_table_active2  ">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td scope="row">1</td>
                                                            <td> <img src="assets/admin/img/currency/1.svg" alt> </td>
                                                            <td>bitcoin.com</td>
                                                            <td>Using - Bank</td>
                                                            <td>-0.454 USD</td>
                                                            <td>$25.00</td>
                                                        ...
                                                        <tr>
                                                            <td scope="row">1</td>
                                                            <td> <img src="assets/admin/img/currency/2.svg" alt> </td>
                                                            <td>bitcoin.com</td>
                                                            <td>Using - Bank</td>
                                                            <td>-0.454 USD</td>
                                                            <td>$25.00</td>
                                                        ...
                                                        <tr>
                                                            <td scope="row">1</td>
                                                            <td> <img src="assets/admin/img/currency/3.svg" alt> </td>
                                                            <td>bitcoin.com</td>
                                                            <td>Using - Bank</td>
                                                            <td>-0.454 USD</td>
                                                            <td>$25.00</td>
                                                        ...
                                                        <tr>
                                                            <td scope="row">1</td>
                                                            <td> <img src="assets/admin/img/currency/4.svg" alt> </td>
                                                            <td>bitcoin.com</td>
                                                            <td>Using - Bank</td>
                                                            <td>-0.454 USD</td>
                                                            <td>$25.00</td>
                            ...
                            <div class="white_card_body ">
                                <div class="news_widget_wrap">
                                    <div class="single_news mb_20">
                                        <div class="thumb mb_20">
                                            <a href="#"><img class="img-fluid"
                                                    src="assets/admin/img/news/1.svg" alt></a>
                                        </div>
                                        <a href="#">
                                    ...
                                    <div class="single_news mb_20">
                                        <div class="thumb mb_20">
                                            <a href="#"><img class="img-fluid"
                                                    src="assets/admin/img/news/2.svg" alt></a>
                                        </div>
                                        <a href="#">
                                            <p class="f_s_18 f_w_400">Aorem psum dolor sit amet, consect
                                                adipisci Quisque scelerisq.</p>
